...
export interface WfLoc { title: string; short: string; sector: string; subSector: string; tagline: string }

const HI: Record<string, WfLoc> = {
  finance: {
    title: "MSME वित्त एवं योजना सलाहकार", short: "वित्त एवं योजनाएँ",
  ...
  receivables: {
    title: "प्राप्य एवं MSME समाधान", short: "प्राप्य एवं समाधान",
  ...
  build: {
    title: "निर्माण, RERA एवं BOQ", short: "अवसंरचना एवं निर्माण",
  ...
  electronics: {
    title: "इलेक्ट्रॉनिक्स, IT एवं टेलीकॉम अनुपालन", short: "इलेक्ट्रॉनिक्स, IT एवं टेलीकॉम",
  ...
  mobility: {
    title: "ऑटो, EV एवं इंजीनियरिंग अनुपालन", short: "धातु, मशीनरी एवं मोबिलिटी",
...
export function wfLoc(e: Pick<Employee, "id" | "title" | "short" | "sector" | "subSector" | "tagline">, isHi: boolean): WfLoc {
  const en: WfLoc = { title: e.title, short: e.short, sector: e.sector, subSector: e.subSector, tagline: e.tagline };
